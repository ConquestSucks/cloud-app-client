...
const DisplayModalFileList = ({ fileList, onRemoveFile }: DisplayModalFileListProps) => {
    return (
            ...
            <div className="overflow-y-auto max-h-[400px] pr-2 custom-scrollbar">
                <div className="space-y-2">
                    {Array.from(fileList).map((file) => (
                        <div 
                            key={file.name} 
                            className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-100 hover:bg-blue-50/50 hover:border-blue-200 transition-all group shadow-[0_2px_8px_rgb(0,0,0,0.02)]"
                        >
